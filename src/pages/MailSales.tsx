      ...
      <div className="kpi-group">
        ...
        <div className="kpi-grid">
          ...
          <KPICard
            ...
            info="Total bruto com IVA (front + upsells + bumps) por pedido recuperado pelo Maileonardo. Indica o ticket médio completo dos carrinhos abandonados convertidos."
          />
          <KPICard
            icon={RotateCcw}
